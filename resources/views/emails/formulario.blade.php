          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: left;">
			            <h1><a href="http://www.gesta.org.ar"> <img src="http://www.gesta.org.ar/fuentes/gesta.png" alt="GESTA" style='width: 60%;padding:10px 20%;' /></a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
                  ...
                  <tr style='width:100%;padding:2em;font-weight:bold;'>
                        ...
                        <td valign="middle" width="100%" style="text-align:left; padding:1em;" colspan=2>
					  	...
					  	<td valign="middle" style="text-align:center; padding: 1em 2.5em;" colspan=2>
					  		<p><a href="mailto:{{$mensaje_enviar['email']}}" class="btn btn-primary" style='background:#9B3675;'>Responder</a></p>
					  	</td>
					</tr>
	      	</table>
	      </tr><!-- end tr -->
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<h3 class="heading">Gesta</h3>
                      	<p>Grupo de empresas sociales de trabajo asociado.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Lisandro De La Torre 32, Villa María</span></li>
					                <li><span class="text"> <a href="mailto:info@gesta.org.ar"> info@gesta.org.ar</a></span></a></li>
                                    <li><span class="text"> (0353) 4535721</span></a></li> 
					              </ul>
                      </td>
                    </tr>
                  </table>
